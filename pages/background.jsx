...
function Background() {
    ...
    return (
        <BannerLayout>
            <div className="grid md:grid-cols-2 md:divide-x-4 md:divide-Green px-4 pb-2 pt-10 aos-fade-out">
                <div className="flex flex-col gap-y-4 order-2 md:order-1  md:mr-12 aos-delay-100 aos-fade-out">
                ...
                <div className="order-1 md:order-2 aos-delay-200 aos-fade-out">
