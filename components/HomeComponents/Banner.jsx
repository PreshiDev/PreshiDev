            ...
            <div className="absolute inset-0 z-20 flex flex-col items-center py-6 justify-center w-full h-full bg-gradient-to-t from-MidNightBlack">
                <div className="bg-LightGray/10 w-[95%] h-[90%] px-4 py-2 rounded-xl overflow-hidden flex md:block">
                    <div className="flex items-center md:items-center md:justify-around">
                        <div className="">
                            <div className="">
                                <h1 className="text-2xl sm:text-2xl xl:text-5xl text-Snow font-bold">Hi, I'M Precious Gift</h1>
                            </div>
                            <div className="">
                        ...
                        <div className="flex justify-center items-center md:w-48 md:h-52 w-full h-full mb-4">
                            <img
                                className="object-cover w-full h-full rounded-lg shadow-md hover:translate-y-1 animate-pulse"
